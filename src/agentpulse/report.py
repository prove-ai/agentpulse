...
Usage:
    agentpulse report              # same as --last
    agentpulse report --last       # last run: full metrics + drift vs baseline
    agentpulse report --all        # table of all stored runs
    agentpulse report --drift      # only runs where drift was detected
    agentpulse report --run <id>   # specific run by run_id prefix
    agentpulse report --clear      # delete all stored runs (with confirmation)
"""
...
from agentpulse.reporter.terminal import print_report
